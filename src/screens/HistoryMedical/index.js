...
import { Container, CardItem, Card, Tab, Tabs, Left, Body, Button, Right, Content } from 'native-base';
          ...
          <Tab heading="访谈" style={{backgroundColor: '#fafafa'}}>
            <Content>
              <Card transparent style={{padding: 0, margin: 0, borderWidth: 1, borderColor: 'red'}}>
                <CardItem bordered={true}>
                  <Left>
                    <Text>存在问题：这里是问题？</Text>
                  </Left>
                  <View><Text>健康指导：</Text></View>
                </CardItem>
                <CardItem button onPress={() => this.navTo({screen: 'Koe.TelephoneInterview', title: '健康访谈'})}>
                  <Right style={{flex:1}}>
                    <Text>就医历史就医历,史就医历史就医历史,就医历史就医历史,就医历史就医历史就医,历史就医历史就医历,史就医历史</Text>
                  </Right>
                </CardItem>
                <CardItem button onPress={() => this.navTo({screen: 'Koe.TelephoneInterview', title: '健康访谈'})}>
                  <Left>
