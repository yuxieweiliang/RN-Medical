          ...
          <View>
            ...
            <View style={styles.bottomView}>
              <OperateButton
                ...
                source={isCameraTorch ? require(`${imagePath}/闪光灯打开.png`) : require(`${imagePath}/video/闪光灯关闭.png`)}
              />
              <OperateButton
                onPress={this.handlerChangeVideo}
                source={disableVideo ? require(`${imagePath}/摄像头打开.png`) : require(`${imagePath}/video/摄像头关闭.png`)}
              />
            </View>
            <View style={styles.bottomView}>
              <OperateButton
                onPress={this.handlerMuteAllRemoteAudioStreams}
                source={isMute ? require(`${imagePath}/icon_muted.png`) : require(`${imagePath}/video/btn_mute.png`)}
              />
              <OperateButton
              ...
              <OperateButton
                ...
                source={isSpeaker ? require(`${imagePath}/icon_speaker.png`) : require(`${imagePath}/video/btn_speaker.png`)}
              />
            </View>
          </View>
          }
