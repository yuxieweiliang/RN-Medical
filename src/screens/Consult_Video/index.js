...
export default class RNAgoraExample extends Component {
  ...
  render() {
    ...
    const imagePath = '../../../assets/images/video'
    if (!isJoinSuccess) {
      return (
        ...
        <View style={styles.absView}>
          ...
          <View>
            <OperateButton
              ...
              source={require(`${imagePath}/btn_endcall.png`)}
            />
            <View style={styles.bottomView}>
              <OperateButton
                onPress={this.handlerChangeCameraTorch}
                imgStyle={{width: 40, height: 40}}
                source={isCameraTorch ? require(`${imagePath}/闪光灯打开.png`) : require(`${imagePath}/闪光灯关闭.png`)}
              />
              <OperateButton
                onPress={this.handlerChangeVideo}
                source={disableVideo ? require(`${imagePath}/摄像头打开.png`) : require(`${imagePath}/摄像头关闭.png`)}
              />
            </View>
            <View style={styles.bottomView}>
              <OperateButton
                onPress={this.handlerMuteAllRemoteAudioStreams}
                source={isMute ? require(`${imagePath}/icon_muted.png`) : require(`${imagePath}/btn_mute.png`)}
              />
              <OperateButton
                onPress={this.handlerSwitchCamera}
                source={require(`${imagePath}/btn_switch_camera.png`)}
              />
              <OperateButton
                onPress={this.handlerSetEnableSpeakerphone}
                source={isSpeaker ? require(`${imagePath}/icon_speaker.png`) : require(`${imagePath}/btn_speaker.png`)}
              />
            </View>
          </View>
          }
